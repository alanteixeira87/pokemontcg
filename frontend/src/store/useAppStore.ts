...
type View = "dashboard" | "explore" | "collection" | "scanner" | "decks" | "wishlist" | "trades" | "profile" | "admin";
...
const validViews: View[] = ["dashboard", "explore", "collection", "scanner", "decks", "wishlist", "trades", "profile", "admin"];
