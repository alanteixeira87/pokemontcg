...
type View = "dashboard" | "explore" | "collection" | "scanner" | "wishlist" | "trades" | "profile" | "admin";
...
const validViews: View[] = ["dashboard", "explore", "collection", "scanner", "wishlist", "trades", "profile", "admin"];
